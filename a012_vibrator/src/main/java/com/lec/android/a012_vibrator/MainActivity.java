...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //하드웨어의 특정 서비스를 가져올때 getSystemService 를 사용
        ...
        btnVib2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                long[] pattern = {100,300,100,700,300,2000}; //단위는 모두 milli sec
                //대기,진동,대기,진동 .... 배열의 홀수 인덱스: 진동 , 짝수 인덱스 : 대기
                vibrator.vibrate(pattern, -1);
                        //진동패턴 (배열) , 0일경우 무한반복 , -1 은 반복없음
                        //양의 정수 : 진동패턴 배열의 해당 인덱스부터 진동 무한 반복
            }
        });
        ...
        btnVib3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                vibrator.vibrate(new long[]{100,1000,100,500,100,500,100,1000},0); //무한반복
            }
        });
